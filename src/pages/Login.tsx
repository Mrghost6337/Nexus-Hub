  ...
  return (
    <div className="min-h-screen bg-black text-white flex flex-col items-center justify-center p-6 relative overflow-hidden">
      ...
      >
        ...
        <p className="text-white/50 mb-10 font-light">Sign in to continue to Nexus Hub</p>

        <div className="w-full flex flex-col gap-4">
          <button 
            onClick={handleGoogleLogin}
            className="glass-button w-full justify-center relative overflow-hidden group"
          >
          ...
          <button className="glass-button w-full justify-center opacity-70 hover:opacity-100">
